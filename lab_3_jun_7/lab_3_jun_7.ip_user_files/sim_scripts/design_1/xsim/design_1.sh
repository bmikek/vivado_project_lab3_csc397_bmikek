...
export RDI_DATADIR="/home/bkanaley/Vivado/2025.1/data"
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/bkanaley/Vivado/2025.1/data/xsim"
  fi
